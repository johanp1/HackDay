...
void rte_data(void)
{
	...
	P10VW_D_precLongAccMeas = 0.04*Rte_Prm_P10VW_D_precLongAccMeas_v();
	P1AK9_SelfSteeredTagAxleThreshSpeed = Rte_Prm_P1AK9_SelfSteeredTagAxleThreshSpeed_v();
	X1C5B_D_lowSpdSnsrSelnLatAScaFac = 0.0392*Rte_Prm_X1C5B_D_lowSpdSnsrSelnLatAScaFac_v();
	X1C6U_D_FltHndlgIndirPrimSigFltScaFac = 0.00394*Rte_Prm_X1C6U_D_FltHndlgIndirPrimSigFltScaFac_v();
	P1A8I_ConfigAxle_4_axle_load_max = 32*Rte_Prm_P1A8I_ConfigAxle_4_axle_load_max_v();
	P10VT_D_precYawJerkInput = 0.01*Rte_Prm_P10VT_D_precYawJerkInput_v();
	P1A8A_ConfigAxle_4_p_thres = 0.0009765625*Rte_Prm_P1A8A_ConfigAxle_4_p_thres_v();
	X1C68_D_FltHndlgPrimSigFltScaFac = 0.00394*Rte_Prm_X1C68_D_FltHndlgPrimSigFltScaFac_v();
	P1A59_ConfigAxle_1_axle_type_liftable = Rte_Prm_P1A59_ConfigAxle_1_axle_type_liftable_v();
	P1A62_ConfigAxle_2_wh_rollingcircu = 0.00025*Rte_Prm_P1A62_ConfigAxle_2_wh_rollingcircu_v();
	P1A71_ConfigAxle_4_axle_type_steered = Rte_Prm_P1A71_ConfigAxle_4_axle_type_steered_v();
	X1C60_T_interventionNoTrustTime = 0.01*Rte_Prm_X1C60_T_interventionNoTrustTime_v();
	P1BGV_SteeringRatio = 0.25*Rte_Prm_P1BGV_SteeringRatio_v();
	...
	P1A7N_ConfigAxle_3_wh_rollingcircu = 0.00025*Rte_Prm_P1A7N_ConfigAxle_3_wh_rollingcircu_v();
	X1C8Y_Tq_minEngineWheelTorque = 100*Rte_Prm_X1C8Y_Tq_minEngineWheelTorque_v();
	X1C5E_D_lowSpdSnsrSelnWhlSpdScaFac = 0.0392*Rte_Prm_X1C5E_D_lowSpdSnsrSelnWhlSpdScaFac_v();
	P10WG_D_normSlipStfnAxle5 = 0.4*Rte_Prm_P10WG_D_normSlipStfnAxle5_v();
	X1DCK_T_absAsrTurnOffDly = 0.01*Rte_Prm_X1DCK_T_absAsrTurnOffDly_v();
	P10W2_M_Axle5SuspVertLoads[0] = 75*(*Rte_Prm_P10W2_M_Axle5SuspVertLoads_v())[0];
	P10W2_M_Axle5SuspVertLoads[1] = 75*(*Rte_Prm_P10W2_M_Axle5SuspVertLoads_v())[1];
	P1A7C_ConfigAxle_2_axle_load_max = 32*Rte_Prm_P1A7C_ConfigAxle_2_axle_load_max_v();
	P10WU_M_Axle1SuspVertLoads[0] = 75*(*Rte_Prm_P10WU_M_Axle1SuspVertLoads_v())[0];
	P10WU_M_Axle1SuspVertLoads[1] = 75*(*Rte_Prm_P10WU_M_Axle1SuspVertLoads_v())[1];
	P1A8L_ConfigAxle_5_axle_type_liftable = Rte_Prm_P1A8L_ConfigAxle_5_axle_type_liftable_v();
	X1C48_Frq_lowSpdSnsrSelnTqFilFrq = 0.1*Rte_Prm_X1C48_Frq_lowSpdSnsrSelnTqFilFrq_v();
	P1A6J_ConfigAxle_1_p_thres = 0.0009765625*Rte_Prm_P1A6J_ConfigAxle_1_p_thres_v();
	P1A6R_ConfigAxle_1_axle_load_max = 32*Rte_Prm_P1A6R_ConfigAxle_1_axle_load_max_v();
	P10WD_D_normSlipStfnAxle2 = 0.4*Rte_Prm_P10WD_D_normSlipStfnAxle2_v();
	P1A83_ConfigAxle_5_axle_load_max = 32*Rte_Prm_P1A83_ConfigAxle_5_axle_load_max_v();
	...
	P1A7Q_ConfigAxle_3_brake_factor = 32*Rte_Prm_P1A7Q_ConfigAxle_3_brake_factor_v();
	X1DU3_T_absAsrRstDelayTime = 0.01*Rte_Prm_X1DU3_T_absAsrRstDelayTime_v();
	...
	P10W3_Stfn_Axle5SuspVertStfns[0] = 500*(*Rte_Prm_P10W3_Stfn_Axle5SuspVertStfns_v())[0] + (1);
	P10W3_Stfn_Axle5SuspVertStfns[1] = 500*(*Rte_Prm_P10W3_Stfn_Axle5SuspVertStfns_v())[1] + (1);
	X1C4J_B_enaSlipCmp = Rte_Prm_X1C4J_B_enaSlipCmp_v();
	P10WX_Stfn_Axle2SuspVertStfns[0] = 500*(*Rte_Prm_P10WX_Stfn_Axle2SuspVertStfns_v())[0] + (1);
	P10WX_Stfn_Axle2SuspVertStfns[1] = 500*(*Rte_Prm_P10WX_Stfn_Axle2SuspVertStfns_v())[1] + (1);
	X1C3K_D_precTrsmOutpShaftSpdMeas = 0.5*Rte_Prm_X1C3K_D_precTrsmOutpShaftSpdMeas_v();
	...
	X1C9S_V_mtnDetnThdSpd = 0.01*Rte_Prm_X1C9S_V_mtnDetnThdSpd_v();
	X1DBJ_A_mtnDetnThdLongAcc = 0.04*Rte_Prm_X1DBJ_A_mtnDetnThdLongAcc_v();
	X1C3E_D_precLongVelRateInit = Rte_Prm_X1C3E_D_precLongVelRateInit_v();
	P1AFC_BrandType = Rte_Prm_P1AFC_BrandType_v();
	X1C49_Frq_lowSpdSnsrSelnSpdFilFrq = 0.5*Rte_Prm_X1C49_Frq_lowSpdSnsrSelnSpdFilFrq_v();
	P1BGZ_SteeringRatioRight2 = 0.25*Rte_Prm_P1BGZ_SteeringRatioRight2_v();
	X1DCG_B_enaAbsAsrDetn = Rte_Prm_X1DCG_B_enaAbsAsrDetn_v();
	P10V2_V_lowSpdSnsrSelnSpdThldUp = 0.02*Rte_Prm_P10V2_V_lowSpdSnsrSelnSpdThldUp_v();
	P10WE_D_normSlipStfnAxle3 = 0.4*Rte_Prm_P10WE_D_normSlipStfnAxle3_v();
	P1CNH_DistRA1ToRA2 = Rte_Prm_P1CNH_DistRA1ToRA2_v();
	X1C5C_D_lowSpdSnsrSelnYawRateScaFac = 0.0392*Rte_Prm_X1C5C_D_lowSpdSnsrSelnYawRateScaFac_v();
	X1C63_D_absTracCompLgtAScaFac = 0.2*Rte_Prm_X1C63_D_absTracCompLgtAScaFac_v();
	P10VU_D_precLatJerkDueToBankAngleInput = 0.05*Rte_Prm_P10VU_D_precLatJerkDueToBankAngleInput_v();
	X1C6V_D_FltHndlgIndirAltvSigFltScaFac = 0.00394*Rte_Prm_X1C6V_D_FltHndlgIndirAltvSigFltScaFac_v();
	P1A7B_ConfigAxle_2_axle_load_min = 32*Rte_Prm_P1A7B_ConfigAxle_2_axle_load_min_v();
	P10W0_M_Axle4SuspVertLoads[0] = 75*(*Rte_Prm_P10W0_M_Axle4SuspVertLoads_v())[0];
	P10W0_M_Axle4SuspVertLoads[1] = 75*(*Rte_Prm_P10W0_M_Axle4SuspVertLoads_v())[1];
	X1C3A_L_trackWidthDrivenAxle = 0.015625*Rte_Prm_X1C3A_L_trackWidthDrivenAxle_v();
	P1A6A_ConfigAxle_1_axle_type_steered = Rte_Prm_P1A6A_ConfigAxle_1_axle_type_steered_v();
	P1A65_ConfigAxle_2_brake_factor = 32*Rte_Prm_P1A65_ConfigAxle_2_brake_factor_v();
	X1C69_D_maxWheelSpeedTrustFac_vec[0] = 0.01*(*Rte_Prm_X1C69_D_maxWheelSpeedTrustFac_vec_v())[0];
	X1C69_D_maxWheelSpeedTrustFac_vec[1] = 0.01*(*Rte_Prm_X1C69_D_maxWheelSpeedTrustFac_vec_v())[1];
	X1C69_D_maxWheelSpeedTrustFac_vec[2] = 0.01*(*Rte_Prm_X1C69_D_maxWheelSpeedTrustFac_vec_v())[2];
	X1C69_D_maxWheelSpeedTrustFac_vec[3] = 0.01*(*Rte_Prm_X1C69_D_maxWheelSpeedTrustFac_vec_v())[3];
	X1C69_D_maxWheelSpeedTrustFac_vec[4] = 0.01*(*Rte_Prm_X1C69_D_maxWheelSpeedTrustFac_vec_v())[4];
	X1C46_Tq_lowSpdSnsrSelnTqThldUp = 100*Rte_Prm_X1C46_Tq_lowSpdSnsrSelnTqThldUp_v();
	P1A7W_ConfigAxle_3_axle_load_min = 32*Rte_Prm_P1A7W_ConfigAxle_3_axle_load_min_v();
	P1BGW_SteeringRatioLeft1 = 0.25*Rte_Prm_P1BGW_SteeringRatioLeft1_v();
	X1C5P_D_precWhlSpdMeas = 0.1*Rte_Prm_X1C5P_D_precWhlSpdMeas_v();
	P1A6V_ConfigAxle_2_axle_type_steered = Rte_Prm_P1A6V_ConfigAxle_2_axle_type_steered_v();
	X1C5W_T_zeroSpdFltrTurnOffDly = 0.01*Rte_Prm_X1C5W_T_zeroSpdFltrTurnOffDly_v();
	X1C8Z_D_wheelSpeedTrustFac_vec[0] = 0.01*(*Rte_Prm_X1C8Z_D_wheelSpeedTrustFac_vec_v())[0];
	X1C8Z_D_wheelSpeedTrustFac_vec[1] = 0.01*(*Rte_Prm_X1C8Z_D_wheelSpeedTrustFac_vec_v())[1];
	X1C8Z_D_wheelSpeedTrustFac_vec[2] = 0.01*(*Rte_Prm_X1C8Z_D_wheelSpeedTrustFac_vec_v())[2];
	X1C8Z_D_wheelSpeedTrustFac_vec[3] = 0.01*(*Rte_Prm_X1C8Z_D_wheelSpeedTrustFac_vec_v())[3];
	X1C8Z_D_wheelSpeedTrustFac_vec[4] = 0.01*(*Rte_Prm_X1C8Z_D_wheelSpeedTrustFac_vec_v())[4];
	P1CNJ_DistRA2ToRA3 = Rte_Prm_P1CNJ_DistRA2ToRA3_v();
	P10WH_L_imuToFrontAxle = 0.01961*Rte_Prm_P10WH_L_imuToFrontAxle_v();
	P10W1_Stfn_Axle4SuspVertStfns[0] = 500*(*Rte_Prm_P10W1_Stfn_Axle4SuspVertStfns_v())[0] + (1);
	P10W1_Stfn_Axle4SuspVertStfns[1] = 500*(*Rte_Prm_P10W1_Stfn_Axle4SuspVertStfns_v())[1] + (1);
	P1A78_ConfigAxle_4_wh_rollingcircu = 0.00025*Rte_Prm_P1A78_ConfigAxle_4_wh_rollingcircu_v();
	P10WS_L_maxCogHeightFullyLaden = 0.0078125*Rte_Prm_P10WS_L_maxCogHeightFullyLaden_v();
	P1K5K_E_EbsSwPackage = Rte_Prm_P1K5K_E_EbsSwPackage_v();
	X1C4U_B_enaLowSpdSnsrSeln = Rte_Prm_X1C4U_B_enaLowSpdSnsrSeln_v();
	P10WV_Stfn_Axle1SuspVertStfns[0] = 500*(*Rte_Prm_P10WV_Stfn_Axle1SuspVertStfns_v())[0] + (1);
	P10WV_Stfn_Axle1SuspVertStfns[1] = 500*(*Rte_Prm_P10WV_Stfn_Axle1SuspVertStfns_v())[1] + (1);
	X1C47_Tq_lowSpdSnsrSelnTqThldLo = 100*Rte_Prm_X1C47_Tq_lowSpdSnsrSelnTqThldLo_v();
	P1A7X_ConfigAxle_3_axle_load_max = 32*Rte_Prm_P1A7X_ConfigAxle_3_axle_load_max_v();
	P1A6K_ConfigAxle_1_brake_factor = 32*Rte_Prm_P1A6K_ConfigAxle_1_brake_factor_v();
	X1DCF_T_mtnLowConfTolrTi = 0.01*Rte_Prm_X1DCF_T_mtnLowConfTolrTi_v();
	P1A6Q_ConfigAxle_1_axle_load_min = 32*Rte_Prm_P1A6Q_ConfigAxle_1_axle_load_min_v();
	P1CSH_FrontAxleArrangement = Rte_Prm_P1CSH_FrontAxleArrangement_v();
	P1A82_ConfigAxle_5_axle_load_min = 32*Rte_Prm_P1A82_ConfigAxle_5_axle_load_min_v();
	X1DBH_D_precLatAccDueToBankAngleInit = 25*Rte_Prm_X1DBH_D_precLatAccDueToBankAngleInit_v();
	P10VX_D_precLatAccMeas = 0.04*Rte_Prm_P10VX_D_precLatAccMeas_v();
	X1C6T_D_FltHndlgAltvSigFltScaFac = 0.00394*Rte_Prm_X1C6T_D_FltHndlgAltvSigFltScaFac_v();
	...
	X1C5A_D_lowSpdSnsrSelnLgtAScaFac = 0.0392*Rte_Prm_X1C5A_D_lowSpdSnsrSelnLgtAScaFac_v();
	X1C61_T_interventionRampUpTime = 0.02*Rte_Prm_X1C61_T_interventionRampUpTime_v();
	P10VS_D_precLongJerkInput = 0.0005*Rte_Prm_P10VS_D_precLongJerkInput_v();
	P1A8H_ConfigAxle_4_axle_load_min = 32*Rte_Prm_P1A8H_ConfigAxle_4_axle_load_min_v();
	P1KME_DistFA1ToFA2 = Rte_Prm_P1KME_DistFA1ToFA2_v();
	X1DBO_D_absTracCompLatAScaFac = 0.0392*Rte_Prm_X1DBO_D_absTracCompLatAScaFac_v();
	X1C5T_D_lowSpdSnsrSelnLgtJerkScaFacSpd = 0.1962*Rte_Prm_X1C5T_D_lowSpdSnsrSelnLgtJerkScaFacSpd_v();
	P10WY_M_Axle3SuspVertLoads[0] = 75*(*Rte_Prm_P10WY_M_Axle3SuspVertLoads_v())[0];
	P10WY_M_Axle3SuspVertLoads[1] = 75*(*Rte_Prm_P10WY_M_Axle3SuspVertLoads_v())[1];
	P1A8B_ConfigAxle_4_brake_factor = 32*Rte_Prm_P1A8B_ConfigAxle_4_brake_factor_v();
	X1C8W_B_enaWheelDeselection = Rte_Prm_X1C8W_B_enaWheelDeselection_v();
	X1DU0_T_absAsrDetnDelayTime = 0.01*Rte_Prm_X1DU0_T_absAsrDetnDelayTime_v();
	P1A7G_ConfigAxle_3_axle_type_steered = Rte_Prm_P1A7G_ConfigAxle_3_axle_type_steered_v();
	X1C3F_D_precYawRateInit = 12*Rte_Prm_X1C3F_D_precYawRateInit_v();
	P1A6H_ConfigAxle_1_wh_rollingcircu = 0.00025*Rte_Prm_P1A6H_ConfigAxle_1_wh_rollingcircu_v();
	P1A70_ConfigAxle_4_axle_type_liftable = Rte_Prm_P1A70_ConfigAxle_4_axle_type_liftable_v();
	X1DCH_A_whlRateAbsAsrDetnThd = 0.04*Rte_Prm_X1DCH_A_whlRateAbsAsrDetnThd_v();
	P1A8V_ConfigAxle_5_p_thres = 0.0009765625*Rte_Prm_P1A8V_ConfigAxle_5_p_thres_v();
	P1A7P_ConfigAxle_3_p_thres = 0.0009765625*Rte_Prm_P1A7P_ConfigAxle_3_p_thres_v();
	P1RPH_NetworkArchitecture = Rte_Prm_P1RPH_NetworkArchitecture_v();
	P10VY_D_precYawRateMeas = 20*Rte_Prm_P10VY_D_precYawRateMeas_v();
	X1C5D_D_lowSpdSnsrSelnTrsmSpdScaFac = 0.0392*Rte_Prm_X1C5D_D_lowSpdSnsrSelnTrsmSpdScaFac_v();
	P1CSI_TagAxleFeatures = Rte_Prm_P1CSI_TagAxleFeatures_v();
	P10WF_D_normSlipStfnAxle4 = 0.4*Rte_Prm_P10WF_D_normSlipStfnAxle4_v();
	X1C62_B_enaTracComp = Rte_Prm_X1C62_B_enaTracComp_v();
	X1DBP_D_absTracCompYawRateScaFac = 0.0392*Rte_Prm_X1DBP_D_absTracCompYawRateScaFac_v();
	X1C7C_V_maxWheelSpeedTrustBreakPoints_vec[0] = 0.05*(*Rte_Prm_X1C7C_V_maxWheelSpeedTrustBreakPoints_vec_v())[0];
	X1C7C_V_maxWheelSpeedTrustBreakPoints_vec[1] = 0.05*(*Rte_Prm_X1C7C_V_maxWheelSpeedTrustBreakPoints_vec_v())[1];
	X1C7C_V_maxWheelSpeedTrustBreakPoints_vec[2] = 0.05*(*Rte_Prm_X1C7C_V_maxWheelSpeedTrustBreakPoints_vec_v())[2];
	X1C7C_V_maxWheelSpeedTrustBreakPoints_vec[3] = 0.05*(*Rte_Prm_X1C7C_V_maxWheelSpeedTrustBreakPoints_vec_v())[3];
	X1C7C_V_maxWheelSpeedTrustBreakPoints_vec[4] = 0.05*(*Rte_Prm_X1C7C_V_maxWheelSpeedTrustBreakPoints_vec_v())[4];
	X1C5U_Frq_lowSpdSnsrSelnSpdFilFrq = 0.1*Rte_Prm_X1C5U_Frq_lowSpdSnsrSelnSpdFilFrq_v();
	P10WZ_Stfn_Axle3SuspVertStfns[0] = 500*(*Rte_Prm_P10WZ_Stfn_Axle3SuspVertStfns_v())[0] + (1);
	P10WZ_Stfn_Axle3SuspVertStfns[1] = 500*(*Rte_Prm_P10WZ_Stfn_Axle3SuspVertStfns_v())[1] + (1);
	X1C29_L_trackWidthNonDrivenAxle = 0.015625*Rte_Prm_X1C29_L_trackWidthNonDrivenAxle_v();
	X1C8X_Tq_minTotalBrakeTorque = 100*Rte_Prm_X1C8X_Tq_minTotalBrakeTorque_v();
	X1C3G_D_precYawAccInit = 8*Rte_Prm_X1C3G_D_precYawAccInit_v();
	P1A64_ConfigAxle_2_p_thres = 0.0009765625*Rte_Prm_P1A64_ConfigAxle_2_p_thres_v();
	P1E5Z_Radar2FrontAxleDist = Rte_Prm_P1E5Z_Radar2FrontAxleDist_v();
	P1A8W_ConfigAxle_5_brake_factor = 32*Rte_Prm_P1A8W_ConfigAxle_5_brake_factor_v();
	P10WC_D_normSlipStfnAxle1 = 0.4*Rte_Prm_P10WC_D_normSlipStfnAxle1_v();
	X1DCI_Frq_whlRateFilFrq = 0.5*Rte_Prm_X1DCI_Frq_whlRateFilFrq_v();
	X1C5Q_D_lowSpdSnsrSelnLgtJerkScaFacTrq = 0.1962*Rte_Prm_X1C5Q_D_lowSpdSnsrSelnLgtJerkScaFacTrq_v();
	P10WR_L_minCogHeightUnladen = 0.0078125*Rte_Prm_P10WR_L_minCogHeightUnladen_v();
	X1C80_V_speedDifferenceBreakPoints_vec[0] = 0.03*(*Rte_Prm_X1C80_V_speedDifferenceBreakPoints_vec_v())[0];
	X1C80_V_speedDifferenceBreakPoints_vec[1] = 0.03*(*Rte_Prm_X1C80_V_speedDifferenceBreakPoints_vec_v())[1];
	X1C80_V_speedDifferenceBreakPoints_vec[2] = 0.03*(*Rte_Prm_X1C80_V_speedDifferenceBreakPoints_vec_v())[2];
	X1C80_V_speedDifferenceBreakPoints_vec[3] = 0.03*(*Rte_Prm_X1C80_V_speedDifferenceBreakPoints_vec_v())[3];
	X1C80_V_speedDifferenceBreakPoints_vec[4] = 0.03*(*Rte_Prm_X1C80_V_speedDifferenceBreakPoints_vec_v())[4];
	P1IJ3_EquivalentWheelbaseTurning = Rte_Prm_P1IJ3_EquivalentWheelbaseTurning_v();
	X1DCM_A_whlRateAbsAsrRstThd = 0.4*Rte_Prm_X1DCM_A_whlRateAbsAsrRstThd_v();
	X1C3D_D_precLongVelInit = 4*Rte_Prm_X1C3D_D_precLongVelInit_v();
	P1AT2_SelfSteeredTagAxleSpeedHysteresis = Rte_Prm_P1AT2_SelfSteeredTagAxleSpeedHysteresis_v();
	P10WT_AgV_maxPitchRate = 0.05*Rte_Prm_P10WT_AgV_maxPitchRate_v();
	P10WW_M_Axle2SuspVertLoads[0] = 75*(*Rte_Prm_P10WW_M_Axle2SuspVertLoads_v())[0];
	P10WW_M_Axle2SuspVertLoads[1] = 75*(*Rte_Prm_P10WW_M_Axle2SuspVertLoads_v())[1];
	P1BGX_SteeringRatioLeft2 = 0.25*Rte_Prm_P1BGX_SteeringRatioLeft2_v();
	X1C9T_V_mtnDetnHysSpd = 0.01*Rte_Prm_X1C9T_V_mtnDetnHysSpd_v();
	X1C6Z_B_enaAbsComp = Rte_Prm_X1C6Z_B_enaAbsComp_v();
	P1BGY_SteeringRatioRight1 = 0.25*Rte_Prm_P1BGY_SteeringRatioRight1_v();
	P10V1_V_lowSpdSnsrSelnSpdThldLo = 0.02*Rte_Prm_P10V1_V_lowSpdSnsrSelnSpdThldLo_v();
	P1A8T_ConfigAxle_5_wh_rollingcircu = 0.00025*Rte_Prm_P1A8T_ConfigAxle_5_wh_rollingcircu_v();
	P1A0N_B_EspNotAvailable = Rte_Prm_P1A0N_B_EspNotAvailable_v();
	P1AZQ_WheelBase = 0.0005*Rte_Prm_P1AZQ_WheelBase_v();
	P1E50_VehicleWidth_mm = Rte_Prm_P1E50_VehicleWidth_mm_v();
	P1M6I_NoOfPulsesPerRevolution = 0.0001*Rte_Prm_P1M6I_NoOfPulsesPerRevolution_v();
